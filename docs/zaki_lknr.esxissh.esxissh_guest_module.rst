.. _zaki_lknr.esxissh.esxissh_guest_module:
    ...
    <table  border=0 cellpadding=0 class="documentation-table">
        <tr>
            ...
            <tr>
                ...
                <td>
                        <div>A list of CD-ROM configurations for the virtual machine</div>
                </td>
            </tr>
                                <tr>
                ...
                <td>
                        <div>The datastore path to the ISO file to use</div>
                </td>
            </tr>
            <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>A list of networks configurations.</div>
                </td>
            </tr>
                                <tr>
                    <td class="elbow-placeholder"></td>
            ...
            <tr>
                ...
                <td>
                        <div>Name of tye portgroup or distributed virtual portgroup for this interface.</div>
                </td>
            </tr>
